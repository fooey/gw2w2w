...
export const Footer = () => {
  return (
    <footer className="mt-20 flex-none ">
      <div className="mx-auto my-10 flex max-w-xl flex-col place-content-center gap-4 text-center text-xs text-slate-700">
        <div className="flex flex-row items-center justify-center">
          <p className="flex w-64 flex-col items-center justify-center">
            <MdEmail className="text-6xl" />
            <span>Please send comments and bugs to</span>
